...
public class GeneralInspector {
	...
	@Test
	public void GeneralInspector() throws InterruptedException
	{
		...
		//Selecting user role
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("General Inspector"));
		...
		String WelComePageHeader = "<strong>General Inspector</strong>";
		String ViewPageSouce = driver.getPageSource();
