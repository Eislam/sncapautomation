...
public class GeneralClerk {
	WebDriver driver;
	
	@Test
	public void GeneralClerk() throws InterruptedException
	{
		...
		//Selecting user role
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("General Clerk"));
		...
		String WelComePageHeader = "<strong>General Clerk</strong>";
		String ViewPageSouce = driver.getPageSource();
