...
public class CentralApprover {
	WebDriver driver;
	
	@Test
	public void CentralApprover() throws InterruptedException
	{
		...
		//Selecting user role
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("Central Approver"));
		...
		String WelComePageHeader = "<strong>Central Approver</strong>";
		String ViewPageSouce = driver.getPageSource();
