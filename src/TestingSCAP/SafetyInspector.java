...
public class SafetyInspector {
	...
	@Test
	public void SateyFeatures() throws InterruptedException
	{
		...
		//Selecting user role from action drop-down
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("Safety Inspector"));
