...
public class InspectionManager {
	...
	@Test
	public void InspectionManager() throws InterruptedException
	{
		...
		//Selecting user role
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("Inspections Manager"));
		...
		String WelComePageHeader = "<strong>Inspections Manager</strong>";
		String ViewPageSouce = driver.getPageSource();
		boolean IsResult = viewPageSouce.contains(WelComePageHeader);
		
		if (isResult)
		{
			System.out.println("PopeUp new window --->PASS");
		}
		else
		{
			System.out.println("FAIL");
