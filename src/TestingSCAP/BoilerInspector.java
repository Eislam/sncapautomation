...
public class BoilerInspector {
	WebDriver driver;
	
	@Test
	public void BoilerInspector() throws InterruptedException
	{
		...
		//Selecting user role
		WebElement ChangRoleDropDown = driver.findElement(By.linkText("Boiler Inspections Manager"));
		...
		String WelComePageHeader = "<strong>Safety Inspector</strong>";
		String ViewPageSouce = driver.getPageSource();
		...
		WebElement inspector = driver.findElement(By.xpath(".//*[@id='s2id_INSPECTOR_ID']/ul"));
		inspector.click();
		inspector.sendKeys("Islam,Ekramul");
		inspector.isSelected();
		
		//Clicking the location button
		WebElement location = driver.findElement(By.xpath("//*[@id='s2id_iaLocNumber']/ul"));
		location.click();
